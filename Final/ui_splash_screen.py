...
"}")
        ...
        self.label_loading.setStyleSheet("color: rgb(253, 255, 139);")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.label_title.setText(_translate("SplashScreen", "<html><head/><body><p><span style=\" color:#fdff8b;\">Pandemic Warrior</span></p></body></html>"))
        self.label_description.setText(_translate("SplashScreen", "<html><head/><body><p><span style=\" color:#fdff8b;\">COVID-19 Information and Guidance software</span></p></body></html>"))
        self.label_loading.setText(_translate("SplashScreen", "loading..."))
        self.label_credits.setText(_translate("SplashScreen", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600; color:#fdff8b;\">Created By</span><span style=\" font-size:12pt; color:#fdff8b;\">: Group L1</span></p></body></html>"))
